...
/checkday [дата] - Проверить, рабочий ли день

🏖️ Отпуска/Больничные/Отгулы:
/vacation - Добавить отпуск
/sick - Добавить больничный
/dayoff - Добавить отгул
/myabsences - Мои периоды отсутствия
/deleteabsence - Удалить период отсутствия
...
/generateschedules [год] - Автоматически создать графики
/updateallschedules - Обновить все графики по выходным`
	}
...
/myabsences - Мои периоды отсутствия
/deleteabsence ID - Удалить период отсутствия
...
• Графики автоматически рассчитываются на основе календаря выходных дней`
